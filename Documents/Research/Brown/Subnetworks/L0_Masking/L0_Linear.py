...
class L0UnstructuredLinear(nn.Module):
    ...
    def __init__(
        ...
        See hardConcrete for other parameters
        ...
        self.mask = HardConcrete(in_features, out_features, init_mean, init_std, temperature=temperature, stretch=stretch, eps=eps)  # type: ignore
